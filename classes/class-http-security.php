...
use LOCALiQ\Plugin\Headers_Migration\Migrate;

class HTTP_Security extends Migrate{
function migrate_sts() {
  $fields_map = [];
...
function migrate_feature_policy(){
